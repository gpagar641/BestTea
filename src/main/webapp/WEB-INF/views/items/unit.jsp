                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " action="insertUnitProcess" id="signupForm" method="get" novalidate="novalidate">
                                  
                            
                           
                                    
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Unit Name</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="unitName" name="unitName" type="text" placeholder="Unit Name"> 
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea rows="2" class=" " id="unitDesc" name="unitDesc" form-control" placeholder="Unit Description"></textarea>
