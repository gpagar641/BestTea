    ...
    <div>
      <table id="itemTable" class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
           ...
           <c:forEach var="unitDetails" items="${unitDetailsList}" varStatus="count">
           
            <tr>
            <td>${count.index+1}</td>
            <td>${unitDetails.unitName}</td>
            <td>${unitDetails.unitDescription}</td>
            <td>${unitDetails.modifiedDate}</td>
